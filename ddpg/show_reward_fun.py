...
import numpy as np
def error_fun(error):
    # error_reward = np.square(error) * 1000  # 待测试
...
def speed_fun(speed):
    ...
    # speed_reward = 2.0E1 / (np.square(speed) + 6.0E-3) - 50
    # speed_reward = 3.0E1 / (np.square(speed) + 5.0E-3) - 50 # 待测试
    speed_reward = 2.0E1 / (np.square(speed) + 5.0E-3) - 50
